...
func (r *GameRepository) UpdateGameStatus(ctx context.Context, gameID int64, newStatus gamev2.GameStatusType) error {
	...
	_, err := r.conn.GetPool().Exec(ctx, queryUpdateStatusQuery, newStatus, gameID)
	if err != nil {
